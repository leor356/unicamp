...
int main() {
  ...
  */
  int X, Y, P, C, E, i, j, k, altura[XMAX], posGarra=0, capotou = 0;
  char matriz[YMAX][XMAX], ordemDosProgramas[EMAX], programas[PMAX][CMAX], segurando=0, condicao=0;
